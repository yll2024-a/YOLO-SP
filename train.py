...
if __name__ == "__main__":
    ...
    if True:
        ...
        optimizer.add_param_group({"params": model.backbone.am1.alpha})
        optimizer.add_param_group({"params": model.backbone.am2.alpha})
        optimizer.add_param_group({"params": model.backbone.am3.alpha})
        optimizer.add_param_group({"params": model.backbone.am4.alpha})
